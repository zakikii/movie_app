...
import 'package:zaki_movie_apps/Widgets/SeasonsList.dart';
...
class _TVShowScreenState extends State<TVShowScreen> {
  ...
  Future<void> fetchData() async {
    recommendedTvShows =
        await APIService().getRecommendedTvShows(widget.movieId, 1);
    setState(() {
      isLoading = false;
    });
  }
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            RecommendedCustomListTV(recommendedTvShows),
                          ],
                        )
                      ]);
                } else {
